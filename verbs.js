const FORMS = [
  { id: 'masu', name: 'Polite present', short: 'ます', simple: 'Polite present or future — “do / will do”', prompt: 'Use the ます form.' },
  { id: 'masen', name: 'Polite negative', short: 'ません', simple: 'Polite present negative — “do not / will not do”', prompt: 'Say it politely in the negative.' },
  { id: 'mashita', name: 'Polite past', short: 'ました', simple: 'Polite past — “did”', prompt: 'Put the polite form in the past.' },
  { id: 'masendeshita', name: 'Polite past negative', short: 'ませんでした', simple: 'Polite past negative — “did not do”', prompt: 'Say it politely: did not…' },
  { id: 'nai', name: 'Plain negative', short: 'ない', simple: 'Casual present negative — “do not / will not do”', prompt: 'Use the casual negative form.' },
  { id: 'ta', name: 'Plain past', short: 'た', simple: 'Casual past — “did”', prompt: 'Use the casual past form.' },
  { id: 'te', name: 'て form', short: 'て', simple: 'Connecting form — links actions or makes requests', prompt: 'Connect it with the て form.' },
  { id: 'potential', name: 'Potential form', short: '可能', simple: 'Ability — “can do”', prompt: 'Say “can do” this verb.' },
  { id: 'passive', name: 'Passive form', short: '受身', simple: 'Passive — “is done / was done”', prompt: 'Form the passive.' },
  { id: 'causative', name: 'Causative form', short: '使役', simple: 'Permission or force — “make / let someone do”', prompt: 'Say “make or let someone do.”' },
  { id: 'causativePassive', name: 'Causative-passive', short: '使役受身', simple: 'Forced action — “be made to do”', prompt: 'Say “be made to do.”' },
  { id: 'volitional', name: 'Plain volitional', short: '意向', simple: 'Casual suggestion or intention — “let’s / I’ll do”', prompt: 'Say “let’s do.”' },
  { id: 'politeVolitional', name: 'Polite volitional', short: 'ましょう', simple: 'Polite suggestion — “let’s do”', prompt: 'Say “let’s do” politely.' },
  { id: 'imperative', name: 'Imperative', short: '命令', simple: 'Strong command — “do it”', prompt: 'Give a direct command.' },
  { id: 'ba', name: 'ば conditional', short: '〜ば', simple: 'General condition — “if one does”', prompt: 'Say “if one does.”' },
  { id: 'tara', name: 'たら conditional', short: '〜たら', simple: 'Condition or sequence — “if / when one does”', prompt: 'Say “if/when one does.”' },
  { id: 'tai', name: 'Desire form', short: '〜たい', simple: 'Personal desire — “want to do”', prompt: 'Say “want to do.”' },
  { id: 'negativeTe', name: 'Negative て form', short: 'なくて', simple: 'Negative connection — “not doing / because one did not”', prompt: 'Connect the negative form.' },
  { id: 'prohibitive', name: 'Negative command', short: '〜な', simple: 'Strong prohibition — “do not do”', prompt: 'Say “do not do.”' }
];
