const FORMS = [
  { id: 'masu', name: 'Polite non-past', formal: 'ます-form', short: 'ます', simple: 'an action done regularly, happening now, or planned for the future: “do / will do”', prompt: 'Use the ます form.' },
  { id: 'masen', name: 'Polite non-past negative', formal: 'ません-form', short: 'ません', simple: 'an action that does not happen or will not happen: “do not / will not do”', prompt: 'Say it politely in the negative.' },
  { id: 'mashita', name: 'Polite past', formal: 'ました-form', short: 'ました', simple: 'a completed action, said politely: “did”', prompt: 'Put the polite form in the past.' },
  { id: 'masendeshita', name: 'Polite past negative', formal: 'ませんでした-form', short: 'ませんでした', simple: 'an action that did not happen, said politely: “did not do”', prompt: 'Say it politely: did not…' },
  { id: 'nai', name: 'Plain non-past negative', formal: 'ない-form', short: 'ない', simple: 'an action that does not happen or will not happen, said casually: “do not / will not do”', prompt: 'Use the casual negative form.' },
  { id: 'ta', name: 'Plain past', formal: 'た-form', short: 'た', simple: 'a completed action, said casually: “did”', prompt: 'Use the casual past form.' },
  { id: 'te', name: 'Conjunctive', formal: 'て-form', short: 'て', simple: 'an action linked to another action, or used in a request', prompt: 'Connect it with the て form.' },
  { id: 'potential', name: 'Potential', formal: '可能形', short: '可能', simple: 'an action someone is able to do: “can do”', prompt: 'Say “can do” this verb.' },
  { id: 'passive', name: 'Passive', formal: '受身形', short: '受身', simple: 'an action received by the subject: “is done / was done”', prompt: 'Form the passive.' },
  { id: 'causative', name: 'Causative', formal: '使役形', short: '使役', simple: 'an action someone makes or allows another person to do', prompt: 'Say “make or let someone do.”' },
  { id: 'causativePassive', name: 'Causative-passive', formal: '使役受身形', short: '使役受身', simple: 'an action someone is forced to do: “be made to do”', prompt: 'Say “be made to do.”' },
  { id: 'volitional', name: 'Plain volitional', formal: '意向形', short: '意向', simple: 'a casual suggestion or intention: “let’s do / I’ll do”', prompt: 'Say “let’s do.”' },
  { id: 'politeVolitional', name: 'Polite volitional', formal: 'ましょう-form', short: 'ましょう', simple: 'a polite suggestion to act together: “let’s do”', prompt: 'Say “let’s do” politely.' },
  { id: 'imperative', name: 'Imperative', formal: '命令形', short: '命令', simple: 'a strong direct order telling someone to act: “do it”', prompt: 'Give a direct command.' },
  { id: 'ba', name: 'Conditional', formal: 'ば-form', short: '〜ば', simple: 'an action used as a general condition: “if one does”', prompt: 'Say “if one does.”' },
  { id: 'tara', name: 'Past conditional', formal: 'たら-form', short: '〜たら', simple: 'an action used as a condition or sequence: “if / when one does”', prompt: 'Say “if/when one does.”' },
  { id: 'tai', name: 'Desiderative', formal: 'たい-form', short: '〜たい', simple: 'an action the speaker wants to do: “want to do”', prompt: 'Say “want to do.”' },
  { id: 'negativeTe', name: 'Negative conjunctive', formal: 'なくて-form', short: 'なくて', simple: 'a negative action linked to another statement: “not doing / because one did not”', prompt: 'Connect the negative form.' },
  { id: 'prohibitive', name: 'Prohibitive', formal: '禁止形', short: '〜な', simple: 'a strong order telling someone not to act: “do not do”', prompt: 'Say “do not do.”' }
];
